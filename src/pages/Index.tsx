        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-left">
              <h3 className="text-xl font-bold text-white mb-4">DHRIMAN DEKA</h3>
              <p className="text-gray-400 mb-4">Data Scientist & ML Engineer specializing in turning complex data into valuable insights.</p>
            ...
            <div className="text-left">
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start">
                  ...
                  <span>contact@dhrimandeka.com</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
