  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/4 left-1/3 w-64 h-64 bg-purple-300/10 dark:bg-purple-700/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="interactive glassmorphism px-8 py-3 bg-purple-600/90 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className={`mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-700 delay-300 ${
            ...
            <div className="glassmorphism p-6 text-center transition-all duration-500 hover:shadow-lg interactive">
              ...
              <h3 className="text-lg font-semibold mb-2 text-purple-800 dark:text-purple-300">Email</h3>
              <p className="text-gray-600 dark:text-gray-300">contact@datascientist.com</p>
            </div>
            ...
            <div className="glassmorphism p-6 text-center transition-all duration-500 hover:shadow-lg interactive">
              ...
              <h3 className="text-lg font-semibold mb-2 text-purple-800 dark:text-purple-300">Location</h3>
            ...
            <div className="glassmorphism p-6 text-center transition-all duration-500 hover:shadow-lg interactive">
              ...
              <h3 className="text-lg font-semibold mb-2 text-purple-800 dark:text-purple-300">Follow</h3>
