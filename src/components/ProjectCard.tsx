        ...
        >
          ...
          <div className="relative z-10 p-6 h-full flex flex-col">
            <div className="flex items-start justify-between mb-4">
              ...
              <span className="bg-amber-500/20 text-amber-300 px-3 py-1 rounded-full text-xs font-medium border border-amber-500/30">
                {mainTech}
              </span>
            </div>
            ...
            {/* View Project Button */}
            <Button 
              className="absolute bottom-6 left-6 bg-amber-600 hover:bg-amber-700 text-white px-4 h-10 flex items-center"
